...
public class EditShareLinkGateway extends SingleResultGateway<ShareLinkEntity> {
	private String linkId;
	private long timeToLive;
	private int downloadMaxCount;
	private String linkPassword;

	public EditShareLinkGateway(String linkId, long timeToLive, int downloadMaxCount, String linkPassword) {
		super();
	...
	protected Request prepareRequest() {
		...
		return new PutRequest("sharelink", params);
	}
}
