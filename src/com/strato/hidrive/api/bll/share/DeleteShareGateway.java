...
public class DeleteShareGateway extends SingleResultGateway<String> {
	private String linkId;

	public DeleteShareGateway(String linkId) {
		super();
	...
	protected Request prepareRequest() {
		return new DeleteRequest("share", new Param("id", this.linkId));
	}
}
