...
public class PutFileGateway extends UploadFileGateway {
	...
	public PutFileGateway(String dir, String fileName, InputStream inputStream, long streamLength) {
		super(dir, fileName, inputStream, streamLength);
	}

	@Override
	protected BaseInputStreamRequest getInputStreamRequest() {
		return new InputStreamPutRequest("file", new Param("dir", dir), new Param("name", fileName));
	}
