...
public class CheckEmailGateway extends HiDriveFreeGateway<Boolean>{
	private String emailForCheck;
	private String country;
	private String language;
	
	public CheckEmailGateway(String emailForCheck, String country, String language) {
		super();
		this.emailForCheck = emailForCheck;
	...
	protected Request prepareRequest() {
		...
		try {
			json.put("email", this.emailForCheck);
		...
		return new PostRequest("check_email", params);
	}
}
