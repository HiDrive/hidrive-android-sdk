...
public class DeleteRequest extends Request {
	...
	public DeleteRequest(String methodName) {
		super(methodName);
	}

	public DeleteRequest(String methodName, BaseParam<?>... params) {
		super(methodName, params);
	}

	public DeleteRequest(String methodName, List<BaseParam<?>> params) {
		super(methodName, params);
	}
	...
	protected HttpRequestBase createHttpRequest(String requestUri, HttpRequestParamsVisitor<?> visitor) throws UnsupportedEncodingException{
		return new HttpDelete(requestUri + visitor.getHttpRequestParams());
	}
